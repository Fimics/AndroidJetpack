...
public final class ToastUtils {
    ...
    private static int yOffset = (int) (64 * AppGlobals.getApplication().getResources().getDisplayMetrics().density + 0.5);
    ...
    private static void show(final int resId, final int duration) {
        show(AppGlobals.getApplication().getResources().getText(resId).toString(), duration);
    }

    private static void show(final int resId, final int duration, final Object... args) {
        show(String.format(AppGlobals.getApplication().getResources().getString(resId), args), duration);
    }
    ...
    private static View getView(final int layoutId) {
        ...
        LayoutInflater inflate = (LayoutInflater) AppGlobals.getApplication().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
