...
public class MutiSeekBarView extends AppCompatSeekBar {
    ...
    private boolean inVideoPositionBeforeMiddle(int mVideoPosition) {
        if (mAdvPosition == AdvPosition.ALL
                || mAdvPosition == AdvPosition.START_MIDDLE) {
    ...
    private boolean isVideoPositionInEnd(long mVideoPosition) {
        ...
        } else if (mAdvPosition == AdvPosition.ONLY_START
                   || mAdvPosition == AdvPosition.ONLY_MIDDLE
                   || mAdvPosition == AdvPosition.START_END
                   || mAdvPosition == AdvPosition.MIDDLE_END) {
