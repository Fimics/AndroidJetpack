...
public class ControlView extends RelativeLayout implements ViewAction, ITheme {
    ...
    private void findAllViews() {
        ...
        mScreenModeBtn = (ImageView) findViewById(R.id.iv_screen_mode);
        mScreenLockBtn = (ImageView) findViewById(R.id.alivc_screen_lock);
        mPlayStateBtn = (ImageView) findViewById(R.id.iv_play);
        mScreenShot = findViewById(R.id.alivc_screen_shot);

        mLargePositionText = (TextView) findViewById(R.id.tv_play_time);
        mLargeDurationText = (TextView) findViewById(R.id.tv_all_time);
        mLargeSeekbar = (SeekBar) findViewById(R.id.seekbar);
    }
...
//        mLargeSeekbar.setThumb(largeThumb);
    ...
    private void updatePlayStateBtn() {
        if (mPlayState == PlayState.NotPlaying) {
            mPlayStateBtn.setImageResource(R.drawable.ic_player_play);
        } else if (mPlayState == PlayState.Playing) {
            mPlayStateBtn.setImageResource(R.drawable.ic_player_pause);
        }
    }
