...
public class CircleTransform extends BitmapTransformation {
    ...
    public CircleTransform(Context context, float borderWidth, int borderColor) {
        mBorderWidth = Resources.getSystem().getDisplayMetrics().density * borderWidth;
        mBorderWidth = dip2px(context,borderWidth);
    ...
    public CircleTransform(Context context, float borderWidth, int borderColor, int heightPX, int widthPx) {
        mBorderWidth = Resources.getSystem().getDisplayMetrics().density * borderWidth;
        mBorderWidth = dip2px(context,borderWidth);
        mBorderPaint = new Paint();
        mBorderPaint.setDither(true);
