...
public class RoundedImageViewOnlyTopCorner extends ImageView {
  ...
  public RoundedImageViewOnlyTopCorner(Context context) {
    super(context);
  }

  public RoundedImageViewOnlyTopCorner(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public RoundedImageViewOnlyTopCorner(Context context, AttributeSet attrs, int defStyle) {
...
//            mCornerRadii[Corner.BOTTOM_LEFT]);
   ...
   * width.
   *
   * @return if this {@link RoundedImageViewOnlyTopCorner} is set to oval.
   */
  ...
  /**
   * Set if the drawable should ignore the corner radii set and always tips_circle the source to
   * exactly half the height or width.
   *
   * @param oval if this {@link RoundedImageViewOnlyTopCorner} should be oval.
   */
  ...
  /**
   * If {@code true}, we will also tips_circle the background drawable according to the settings on this
   * ImageView.
   *
  ...
  /**
   * Set whether the {@link RoundedImageViewOnlyTopCorner} should tips_circle the background drawable according to
