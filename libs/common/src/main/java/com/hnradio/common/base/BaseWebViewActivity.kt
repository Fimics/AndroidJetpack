...
import com.hnradio.common.util.MyJsInterfaceHolder
...
abstract class BaseWebViewActivity : AppCompatActivity() {
    ...
    protected open fun buildAgentWeb() {
        ...
        mAgentWeb = AgentWeb.with(this)
            ...
            .setOpenOtherPageWays(OpenOtherPageWays.DISALLOW) //打开其他页面时，弹窗质询用户前往其他应用 AgentWeb 3.0.0 加入。
            .interceptUnkownUrl()
            .createAgentWeb()
            .ready()
            .go(getUrl())
