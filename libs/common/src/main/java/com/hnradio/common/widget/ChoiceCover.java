...
public class ChoiceCover extends View {
    ...
    private void init() {
        ...
        int dp5 = (int) getResources().getDimension(R.dimen.dp_2);
        mPaint.setStrokeWidth(dp5);

        //bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.video_thumbnail);

        rectWidth = (int) getResources().getDimension(R.dimen.dp_2);
        minPx = (int) getResources().getDimension(R.dimen.dp_28);
    }
