...
public class AudioChannel {
    private DerryPusher mPusher; // 把AudioRecord音频数据 回调给中转站，其他数据 回调给中转站，只有中转站才有资格和C++层打交道
    ...
    public AudioChannel(DerryPusher pusher) {
        this.mPusher = pusher;
        ...
        // TODO Log.d("Derry", "AudioChannel.java inputSamples:" + inputSamples); // AudioChannel.java inputSamples:4096
