...
import com.mic.hilt.demo.DemoActivity;
import com.mic.hilt.demo.DemoActivity_MembersInjector;
import com.mic.hilt.demo.hilt.HiltFragment;
import com.mic.hilt.demo.hilt.HiltFragment_MembersInjector;
import com.mic.hilt.demo.hilt.di.InterfaceImpl;
import com.mic.hilt.demo.hilt.module.HttpModule;
import com.mic.hilt.demo.hilt.module.HttpModule_GetHttpObjectFactory;
import com.mic.hilt.demo.hilt.object.HttpObject;
import com.mic.hilt.demo.http.client.XUtilsProcessor;
import com.mic.hilt.demo2.AppModule;
import com.mic.hilt.demo2.AppModule_ProvideStudentFactory;
import com.mic.hilt.demo2.Demo2Activity;
import com.mic.hilt.demo2.Demo2Activity_MembersInjector;
import com.mic.hilt.demo2.Student;
import com.mic.hilt.demo2.User;
...
public final class DaggerHiltApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCBuilder implements HiltApp_HiltComponents.ActivityC.Builder {
    ...
    public HiltApp_HiltComponents.ActivityC build() {
      ...
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, new AppModule(), new HttpModule(), activity);
    }
  }
  ...
  private static final class FragmentCImpl extends HiltApp_HiltComponents.FragmentC {
    ...
    @Override
    public void injectHiltFragment(HiltFragment arg0) {
      injectHiltFragment2(arg0);
    }
    ...
    private HiltFragment injectHiltFragment2(HiltFragment instance) {
      HiltFragment_MembersInjector.injectHttpObject(instance, activityCImpl.getHttpObjectProvider.get());
      HiltFragment_MembersInjector.injectIi(instance, new InterfaceImpl());
      return instance;
    }
  }
  ...
  private static final class ActivityCImpl extends HiltApp_HiltComponents.ActivityC {
    ...
    Provider<Student> provideStudentProvider;

    Provider<HttpObject> getHttpObjectProvider;

    ActivityCImpl(SingletonCImpl singletonCImpl, ActivityRetainedCImpl activityRetainedCImpl,
        AppModule appModuleParam, HttpModule httpModuleParam, Activity activityParam) {
      this.singletonCImpl = singletonCImpl;
      this.activityRetainedCImpl = activityRetainedCImpl;
      this.appModule = appModuleParam;
      this.httpModule = httpModuleParam;
      initialize(appModuleParam, httpModuleParam, activityParam);

    }

    XUtilsProcessor xUtilsProcessor() {
      return new XUtilsProcessor(ApplicationContextModule_ProvideApplicationFactory.provideApplication(singletonCImpl.applicationContextModule));
    }

    @SuppressWarnings("unchecked")
    private void initialize(final AppModule appModuleParam, final HttpModule httpModuleParam,
        final Activity activityParam) {
      this.provideStudentProvider = DoubleCheck.provider(new SwitchingProvider<Student>(singletonCImpl, activityRetainedCImpl, activityCImpl, 0));
      this.getHttpObjectProvider = DoubleCheck.provider(new SwitchingProvider<HttpObject>(singletonCImpl, activityRetainedCImpl, activityCImpl, 1));
    }

    @Override
    public void injectDemoActivity(DemoActivity arg0) {
      injectDemoActivity2(arg0);
    }

    @Override
    public void injectDemo2Activity(Demo2Activity arg0) {
      injectDemo2Activity2(arg0);
    }
    ...
    @CanIgnoreReturnValue
    private DemoActivity injectDemoActivity2(DemoActivity instance) {
      DemoActivity_MembersInjector.injectHttp(instance, xUtilsProcessor());
      return instance;
    }

    @CanIgnoreReturnValue
    private Demo2Activity injectDemo2Activity2(Demo2Activity instance2) {
      Demo2Activity_MembersInjector.injectUser(instance2, new User());
      Demo2Activity_MembersInjector.injectStudent(instance2, provideStudentProvider.get());
      return instance2;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.mic.hilt.demo2.Student
          return (T) AppModule_ProvideStudentFactory.provideStudent(activityCImpl.appModule);

          case 1: // com.mic.hilt.demo.hilt.object.HttpObject
          return (T) HttpModule_GetHttpObjectFactory.getHttpObject(activityCImpl.httpModule);
