...
public abstract class Hilt_HiltFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HiltFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HiltFragment_GeneratedInjector) this.generatedComponent()).injectHiltFragment(UnsafeCasts.<HiltFragment>unsafeCast(this));
    }
  }
