package data.structure.hashmap.map;

import data.structure.hashmap.printer.BinaryTreeInfo;
import data.structure.hashmap.printer.BinaryTrees;
		...
		do {
			...
			if (h1 > h2) {
				...
				if ((node.left != null && (result = findNode(node.left, k1)) != null)
					...
					searched = true;
					//System.identityHashCode 内存地址的hashCode
					cmp = System.identityHashCode(k1) - System.identityHashCode(k2);
				}
			}
